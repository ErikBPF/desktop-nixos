...
def raw():
    ...
    def container(name,identifier,image_id,image_ref,state,mounts):
        ...
        return {"Id":identifier,"Image":image_id,"Name":"/"+name,"RestartCount":0,"Config":{"Image":image_ref,"Labels":labels},"Mounts":mounts,"NetworkSettings":{"Networks":{"homelab-net":{"NetworkID":"9"*64}}},"State":runtime}
