          ...
          http = {
            ...
            routers = {
              prometheus = {
                ...
                rule = "Host(`prometheus.homelab.erikmajid.dev`)";
                service = "prometheus";
                tls.certResolver = "letsencrypt";
              };
              grafana = {
                entryPoints = ["websecure"];
                rule = "Host(`grafana.homelab.erikmajid.dev`)";
                service = "grafana";
                tls.certResolver = "letsencrypt";
              };
              promtail = {
                entryPoints = ["websecure"];
                rule = "Host(`promtail.homelab.erikmajid.dev`)";
                service = "promtail";
                tls.certResolver = "letsencrypt";
              };
              alertmanager = {
                entryPoints = ["websecure"];
                rule = "Host(`alertmanager.homelab.erikmajid.dev`)";
      ...
      grafana = {
        ...
        settings = {
          server = {
            http_port = 3010;
            http_addr = "127.0.0.1";
            root_url = "https://grafana.homelab.erikmajid.dev";
          };

          "auth" = {
            signout_redirect_url = "https://authentik.erikmajid.dev/application/o/grafana/end-session/";
          ...
          "auth.generic_oauth" = {
            ...
            auth_url = "https://authentik.erikmajid.dev/application/o/authorize/";
            token_url = "https://authentik.erikmajid.dev/application/o/token/";
            api_url = "https://authentik.erikmajid.dev/application/o/userinfo/";
