      ...
      cloudflared = {
        tunnels = {
          "ec0b6af0-a823-4616-a08b-b871fd2c7f58" = {
            ingress = {
              "authentik.erikmajid.dev" = "http://localhost:9000";
            };
          };
        };
      };
          ...
          http = {
            ...
            routers = {
              auth = {
                ...
                rule = "Host(`authentik.erikmajid.dev`) || HostRegexp(`{subdomain:[a-z0-9]+}.homelab.erikmajid.com`) && PathPrefix(`/outpost.goauthentik.io/`)";
                service = "auth";
