...
class ProductionRunner:
    ...
    def capture_inventory(self):
        output=subprocess.run(["sudo","-n","discovery-stateful-adguard-inventory","capture"],check=True,stdout=subprocess.PIPE,stderr=subprocess.DEVNULL,text=True,timeout=30).stdout
