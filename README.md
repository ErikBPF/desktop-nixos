...
| **apollo** | Remote development host | Intel | 64 GB | 2× RTX 5060 Ti | 2×240 GB SSD Btrfs RAID1 · 2×4 TB data RAID1 | 192.168.10.174 |
...
just diagnose-apollo-worklab       # Apollo host/session/cache proof
