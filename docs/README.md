...
| [`proposals/2026-06-29-repo-ssot-srp.md`](proposals/2026-06-29-repo-ssot-srp.md) | Plan (decisions locked 2026-06-29) — SSOT per fact + SRP per repo across the 8-repo ecosystem: home/lab peer envs, platform Vault, fleet-topology SSOT, Harbor+GHCR, kindle-dash→OSS; per-SSOT implementation plans P0–P5. |
