...
| [`proposals/2026-06-29-repo-ssot-srp.md`](proposals/2026-06-29-repo-ssot-srp.md) | Implementing (2026-06-29) — SSOT per fact + SRP per repo across the 8-repo ecosystem. **P0/P1/P2/P3/P5 done** (`fleet.json` topology+domains SSOT, consumers live in justfile + homelab-iac + servarr drift-check; CLAUDE.md ownership map + D1–D9 + SRP tree); **P4** (kindle-dash→OSS image publish) remaining. |
...
| [`proposals/2026-06-29-codex-flake.md`](proposals/2026-06-29-codex-flake.md) | Draft RFC — reusable `codex-flake` Home Manager profile module for global Codex `AGENTS.md`, inline RTK guidance, caveman style, and opt-in `config.toml`. |
