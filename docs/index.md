...
```json
{ "openid_connect": { "SERVERS": [ { "id": "tandoor", "name": "authentik", "server_url": "https://auth.homelab.erikmajid.dev/application/o/tandoor/.well-known/openid-configuration", "token_auth_method": "client_secret_basic", "APP": { "client_id": "", "secret": "", }, } ] }}
```
          ...
          http = {
            ...
            routers = {
              recipes = {
                ...
                rule = "Host(`recipes.homelab.erikmajid.dev`)";
                service = "recipes";
              ...
              recipes-media = {
                entryPoints = ["websecure"];
                rule = "Host(`recipes.homelab.erikmajid.dev`) && PathPrefix(`/media`)";
        ...
        dynamicConfigOptions = {
          http = {
            ...
            routers = {
              auth = {
                entryPoints = ["websecure"];
                rule = "Host(`auth.homelab.erikmajid.dev`) || HostRegexp(`{subdomain:[a-z0-9]+}.homelab.erikmajid.com`) && PathPrefix(`/outpost.goauthentik.io/`)";
                service = "auth";
                tls.certResolver = "letsencrypt";
              };
            };
...
````nix
  sonarr = {
    entryPoints = ["websecure"];
    rule = "Host(`sonarr.homelab.erikmajid.dev`)";
    service = "sonarr";
    tls.certResolver = "letsencrypt";
...
hostname needs to be like tandoor-recipes.erikmajid.dev
...
```yaml
tandoor: |
    SOCIALACCOUNT_PROVIDERS='{ "openid_connect": { "SERVERS": [ { "id": "tandoor", "name": "authentik", "server_url": "https://authentik.erikmajid.dev/application/o/tandoor/.well-known/openid-configuration", "token_auth_method": "client_secret_basic", "APP": { "client_id": "", "secret": "", }, } ] }}'
    SECRET_KEY=""
```
...
[
    ...
    HOMEPAGE_VAR_SYNOLOGY_URL=https://nas.homelab.erikmajid.dev
      ...
      cloudflared = {
        ...
        tunnels = {
          "ec0b6af0-a823-4616-a08b-b871fd2c7f58" = {
            ingress = {
              "navidrome.erikmajid.dev" = "https://localhost";
            };
          };
        };
      };
        ...
        dynamicConfigOptions = {
          http = {
            ...
            routers = {
              navidrome = {
                entryPoints = ["websecure"];
                rule = "Host(`navidrome.erikmajid.dev`)";
                service = "navidrome";
                tls.certResolver = "letsencrypt";
                middlewares = ["authentik"];
              };
