...
| A12 | **Voice assistant §6: quais sinergias valem** | [`2026-05-27-home-assistant-voice-assistant.md`](2026-05-27-home-assistant-voice-assistant.md) — núcleo entregue; aberto só: visão por câmera, ponte hermes-MCP, clone de voz f5-tts, memória RAG, anúncios Alexa | Escolher 0–2 para RFC próprio; o resto morre |
...
| B7 | **Grafana Fase 3: alertas do cluster k3s** | [`2026-06-29-grafana-fleet-monitoring.md`](2026-06-29-grafana-fleet-monitoring.md) — kube-state-metrics já roda no cluster | Escrever rules KSM (pod crashloop, PVC, node) no rules.yaml do servarr |
...
| B9 | **telstar: provisionar quando houver capacidade A1** | [`2026-07-01-telstar-oracle-arm-host.md`](2026-07-01-telstar-oracle-arm-host.md) — 100% staged, 586 tentativas "out of capacity" | Re-tentar `terragrunt apply`; sucesso → `just deploy-telstar` + `just switch-telstar` → graduar o RFC |
